...
let g:airline#themes#jellybeans_ak#palette = {}
...
let g:airline#themes#jellybeans_ak#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
...
let g:airline#themes#jellybeans_ak#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
...
let g:airline#themes#jellybeans_ak#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
...
let g:airline#themes#jellybeans_ak#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)

" Inactive mode
let s:IN1 = [ s:gui00 , s:gui01 , s:cterm02 , s:cterm01 ]
let s:IN2 = [ s:gui02 , s:gui00 , s:cterm02 , s:cterm00 ]
let s:IN3 = [ s:gui02 , s:gui00 , s:cterm02 , s:cterm00 ]
let g:airline#themes#jellybeans_ak#palette.inactive = airline#themes#generate_color_map(s:IN1, s:IN2, s:IN3)
...
let g:airline#themes#jellybeans_ak#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(s:CP1, s:CP2, s:CP3)
