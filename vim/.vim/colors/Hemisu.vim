...
if version >= 700
  ...
  call s:h("MatchParen",  { "fg": s:accent1, "bg": s:faint, "gui": "bold", "cterm": "bold" })
  ...
  call s:h("SpellCap",    { "sp": s:accent1, "gui": "undercurl", "cterm": "undercurl" })
  call s:h("SpellRare",   { "sp": s:normGreen, "gui": "undercurl", "cterm": "undercurl"})
  call s:h("SpellLocal",  { "sp": s:accent4, "gui": "undercurl", "cterm": "undercurl"})
...
call s:h("Pmenu",        { "fg": s:norm, "bg": s:darkGrey })
